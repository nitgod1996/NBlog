        ...
        <div class="m-box">
            <div class="card">
                ...
                <div class="content" align="center">
                    ...
                    <p class="description">宁理大神1996的笔记</p>
                    <!--彩色滚动字体-->
                ...
                <div class="extra content" align="center">
                    ...
                    <!-- 纸飞机 -->
                    <a :href="introduction.telegram" v-if="introduction.telegram" target="_blank" class="ui circular icon button">
                    ...
                    <a :href="introduction.qq" v-if="introduction.qq" target="_blank" class="ui circular icon button">
                        <svg style="width: 1em !important; height: 1em !important" t="1588658755157" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6709" width="200" height="200">
                            ...
                            <path
                                d="M806.50411733 427.2384s-130.112 43.07946667-302.6592 44.30826667h-1.02613333c-172.26346667-1.22346667-302.21653333-44.16106667-302.66026667-44.30826667l-43.5776 114.08213333c108.9984 34.464 244.0928 56.67733333 346.23786667 55.38773334l1.024-0.00213334c102.15253333 1.29706667 237.22666667-20.91733333 346.24-55.3856l-43.57866667-114.08213333z"
                                fill="#EB1C26"
                                p-id="6719"></path>
                        </svg>
                    </a>
                ...
                <div>
                    <!-- 这里怎么设计待定-->
                    <!-- 导航菜单 -->
                    <el-menu class="side-menu" default-active="1" text-color="#333" active-text-color="#409EFF">
                        <el-menu-item index="1" @click="jumpPage('/home')" class="anime-gradient-btn">
                            <i class="home icon"></i>
                            <span>首页</span>
                        ...
                        <el-menu-item index="3" @click="jumpPage('/archives')">
                            <i class="clone icon"></i>
                            <span>归档</span>
                        </el-menu-item>
                        <el-menu-item index="4" @click="jumpPage('/moments')">
                        ...
                        <el-menu-item index="6" @click="jumpPage('/about')">
                            <i class="info icon"></i>
                            <span>关于</span>
                        </el-menu-item>
                    </el-menu>
...
.side-menu {
    ...
    .is-active {
        ...
        overflow: hidden;
        background: linear-gradient(135deg, #ed78c0 0%, #fd8cdb 30%, #f98fe8 70%, #edb0ed 100%);
        color: white !important;
        text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2);
        box-shadow: 0 4px 20px rgba(168, 85, 247, 0.4), 0 0 12px rgba(255, 107, 255, 0.6);

        /* 悬停动效 */
        &:hover {
            transform: scale(1.02);
            box-shadow: 0 8px 32px rgba(168, 85, 247, 0.6), 0 0 24px rgba(255, 107, 255, 0.8);
